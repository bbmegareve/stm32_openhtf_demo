...
if command -v STM32_Programmer_CLI &> /dev/null; then
    ...
    echo "  And update the test configuration YAML in programmer_cli with the correct path if necessary"
fi
echo ""
...
echo "  python3 run_tests.py --test t001_my_hello_world_test"
echo ""
